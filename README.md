...
بما أن هذا المشروع مرخّص بموجب [رخصة مدارك تولز — النسخ والتوزيع بدون تعديل](LICENSE)، فإن المساهمة بالكود (Pull Requests) غير متاحة، لأن أي تعديل على الكود يتعارض مع شروط الرخصة.
...
- **التواصل المباشر** عبر [GitHub](https://github.com/mmuhacker) لأي استفسار
