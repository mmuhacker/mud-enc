...
[#-نسخة-مضغوطة-اختياري](#-نسخة-مضغوطة-اختياري)
...
لمن يفضّل نسخة جاهزة مضغوطة بدل قراءة الكود، متوفرة هون: [`dist/mud_enc_protected.py`](dist/mud_enc_protected.py)
...
- **فتح Issue** لاقتراح ميزة أو تحسين — راح أراجعها وأنفذها بنفسي إذا كانت مناسبة
