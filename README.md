...
![Python](https://img.shields.io/badge/3.x-%EF%BA%91%EF%BA%8E%EF%BB%B3%EF%BA%9C%EF%BB%AE%EF%BB%A6-blue?style=for-the-badge&logo=🐍)<br>
...
<div align="center" id="مضغوط">

## 📦 نسخة مضغوطة (اختياري)

</div>

[#-نسخة-مضغوطة-اختياري](dist/mud_enc_p.py)

النسخة الرئيسية بالمستودع (`mud_enc.py`) هي الكود المصدري الكامل والمقروء — تقدر تراجعه بنفسك قبل التشغيل، وهذا موصى به دائماً خصوصاً لأداة تشفير.

لمن يفضّل نسخة جاهزة مضغوطة بدل قراءة الكود، متوفرة هون: [`dist/mud_enc_protected.py`](dist/mud_enc_p.py)

> النسخة المضغوطة مطابقة وظيفياً 100% للنسخة الأصلية (نفس الكود، بس مضغوط ومعمّى بأداة خاصة)، وتُستخدم بنفس الطريقة تماماً.
...
<div align="center" id="إبلاغ">

## 🤝 الإبلاغ عن مشاكل

</div>

بما أن هذا المشروع مرخّص بموجب [رخصة مدارك تولز — النسخ والتوزيع بدون تعديل](https://github.com/mmuhacker/mud-enc/blob/main/LICENSE.md)، فإن المساهمة بالكود (Pull Requests) غير متاحة، لأن أي تعديل على الكود يتعارض مع شروط الرخصة.

بدلاً من ذلك، يسعدني تلقي ملاحظاتك عبر:

- **فتح Issue** للإبلاغ عن خطأ أو مشكلة تقنية
- **فتح Issue** لاقتراح ميزة أو تحسين — سوف أراجعها وأنفذها بنفسي إذا كانت مناسبة.
- **التواصل المباشر** عبر [![GitHub](https://img.shields.io/badge/GitHub-mmuhacker-black?style=for-the-badge&logo=github)](https://github.com/mmuhacker) لأي استفسار

⚠️ لا يُقبل أي Pull Request يحتوي تعديلاً على الكود المصدري، حفاظاً على التزام المشروع برخصته.
